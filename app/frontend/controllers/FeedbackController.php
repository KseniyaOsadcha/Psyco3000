...
class FeedbackController extends ControllerBase
{
    ...
    {
        $this->tag->setTitle('Записаться на косультацию');
        $this->tag->setDescription('Психолог, Гештальт-терапевт, психиатр. Услуги квалифицированных и опытных специалистов.');
...
//                    mail("theksenic@gmail.com", "Test", $mail);
    ...
    public function contactAction()
    {
        ...
        $this->tag->setDescription('Психолог, Гештальт-терапевт, психиатр. Доступные цены. Оболонь, Соломенский район.');
