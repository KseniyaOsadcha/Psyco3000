...
<nav id="paginator" aria-label="Page navigation" class="pull-right">
    <ul class="pagination justify-content-center">
        ...
        <li class="page-item {% if current_page == previous_page %} disabled {% endif %}" >
            <a class="page-link" href="#" data-page="{{ previous_page }}" aria-label="Previous" data-params='{{ params|default('{}') }}'>
                <span aria-hidden="true">‹</span></a></li>
        {% for i in (range_start..range_end) %}
            <li class="page-item {% if current_page == i %} active {% endif %}" ><a data-page="{{ i }}" class="page-link" href="#" data-params='{{ params|default('{}') }}'>{{ i }}</a></li>
        {% endfor %}
        <li class="page-item {% if current_page == next_page %} disabled {% endif %}" >
            <a class="page-link" href="#" data-page="{{ next_page }}" aria-label="Next" data-params='{{ params|default('{}') }}'>
                <span aria-hidden="true">›</span></a>
        </li>
        <li class="page-item {% if current_page == total_pages %} disabled {% endif %}" >
            <a class="page-link" href="#" data-page="{{ total_pages }}" aria-label="Next" data-params='{{ params|default('{}') }}'>
                <span aria-hidden="true">»</span></a>
        </li>
    </ul>
</nav>
